...
import com.dzrcx.jiaan.Order.RateUsAdp;
 ...
 * 评价我们
 */
public class RatedUsFragDayShare extends YYBaseFragment implements View.OnClickListener, RequestInterface, WXShareCallBackListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (contentView == null) {
            contentView = inflater.inflate(R.layout.frag_ratedus_day_share, null);
            initView();
            requestData(true);
