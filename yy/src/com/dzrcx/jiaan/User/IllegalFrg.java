 ...
 */
public class IllegalFrg extends YYBaseFragment implements View.OnClickListener, RequestInterface {

    private View breakRulesView;
    private LinearLayout ll_messagecount;
    private TextView tv_Illeaglecount, tv_Illeaglenotcomplete, tv_Illeaglepoint, tv_Illeaglemoney;
    ...
    private void initView() {
        ...
        tv_Illeaglecount = (TextView) heardView_break.findViewById(R.id.tv_Illeaglecount);
        tv_Illeaglenotcomplete = (TextView) heardView_break.findViewById(R.id.tv_Illeaglenotcomplete);
        tv_Illeaglepoint = (TextView) heardView_break.findViewById(R.id.tv_Illeaglepoint);
        tv_Illeaglemoney = (TextView) heardView_break.findViewById(R.id.tv_Illeaglemoney);
        ll_messagecount = (LinearLayout) heardView_break.findViewById(R.id.ll_messagecount);
        ll_messagecount.setVisibility(View.VISIBLE);
        ...
        MyUtils.setViewsOnClick(this, rl_accident);
    }
    ...
    public void onComplete(int tag, String json) {
        ...
        if (listBean != null && listBean.getErrno() == 0) {
            ...
            rulesAdp.setViolationBeans(listBreak);
            tv_Illeaglecount.setText(listBean.getReturnContent().getViolationCount() + "次");
            tv_Illeaglenotcomplete.setText(listBean.getReturnContent().getUndoViolationCount() + "次");
            tv_Illeaglepoint.setText(listBean.getReturnContent().getViolationPoints() + "分");
            tv_Illeaglemoney.setText(listBean.getReturnContent().getViolationAmount() + "");

            tv_nodatatag.setText("没有违章记录，棒棒哒");
        } else {
