 ...
 * 提示信息dialog
 */
public class MapCarFrgDialog extends Dialog implements View.OnClickListener {
     ...
     * @param rightText
     */
    public MapCarFrgDialog(Context context, String leftText, String rightText,
                           String message,
                           String title
    ) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dlg_mapcarfrg_remind);
